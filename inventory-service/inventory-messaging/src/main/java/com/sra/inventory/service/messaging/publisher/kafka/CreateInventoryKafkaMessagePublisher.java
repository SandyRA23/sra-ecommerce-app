package com.sra.inventory.service.messaging.publisher.kafka;

import com.sra.inventory.service.domain.config.InventoryServiceConfigData;
...
import com.sra.kafka.inventory.avro.model.OrderRequestAvroModel;
